...
EMAIL = "arapnecmi2@gmail.com"  # Your email address
PASSWORD = "stxe sisc qfnu zgqk"  # Your email password (should be kept secure)
OPENAI_API_KEY = "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"  # OpenAI API key for using GPT models
